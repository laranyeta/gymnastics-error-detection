...
This directory contains the evaluation results, charts, and performance metrics of the complete Artificial Intelligence pipeline developed for the Bachelor's Thesis. The project is divided into two main phases, whose metrics are detailed below.
...
**Global Accuracy:** 76.0% (0.76)<br>
**Total test videos:** 29 routines
...
![Confusion Matrix](confusion_matrix_rnn.png)<br>
...
**2. Opening Bias (Split vs. Straddle):** <br>
